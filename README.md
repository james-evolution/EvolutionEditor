...
To constrain the size of your editor, I recommend wrapping it in a container element. For example, a <div> with the class .container You can then apply styling as you'd like. For example, if you wish to restrict its width to 80% of the viewport and it's height to 800 pixels, and you wish to center it, you could do this:
